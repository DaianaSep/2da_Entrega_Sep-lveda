//Variables
let seguirCarga, res, totalCalorias, caloriasDia = 0, mje, alimReg, alimNuevos
let alimentos = []
let alimfilt2 = []
...
// Función para guardar los alimentos ingresados
function guardarAlimentos() {
    alimReg = JSON.parse(localStorage.getItem("alimentos")) ?? [] 
    localStorage.setItem('alimentos', JSON.stringify(alimentos))
}